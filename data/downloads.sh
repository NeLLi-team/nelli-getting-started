...
curl -L "https://zenodo.org/records/15083711/files/cami2_toy_R1.fastq.gz?download=1" \
  -o "$DATA_DIR/cami2_toy_R1.fastq.gz"
curl -L "https://zenodo.org/records/15083711/files/cami2_toy_R2.fastq.gz?download=1" \
  -o "$DATA_DIR/cami2_toy_R2.fastq.gz"
